...
# # # # def check_paypal():  # PayPal désactivé  # PayPal désactivé
...
# # # # base = "https://api-m.sandbox.paypal.com" if mode=="sandbox" else "https://api-m.paypal.com"  # PayPal désactivé  # PayPal désactivé
    try:
...
def main():
    ...
    while True:
        ...
        check_keys()
# # # # if int(time.time()) % 600 < 30: check_paypal()  # PayPal désactivé  # PayPal désactivé
        time.sleep(30)
